...
export class Backend implements backendInterface {
    ...
    async getAllProfiles(): Promise<Array<T>> {
        if (this.processError) {
            try {
    ...
    async getCallerProfile(): Promise<T> {
        if (this.processError) {
            try {
    ...
    async getTopScores(): Promise<Array<T__1>> {
        if (this.processError) {
            try {
    ...
    async getUserHighScore(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getUserProfile(arg0: Principal): Promise<T> {
        if (this.processError) {
            try {
    ...
    async submitGameResults(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitGameResults(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async validateUsername(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.validateUsername(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
